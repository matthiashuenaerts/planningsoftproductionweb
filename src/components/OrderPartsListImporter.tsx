...
interface OrderPartsListImporterProps {
  orderId: string;
  projectId: string;
  onImportComplete?: () => void;
}

export const OrderPartsListImporter: React.FC<OrderPartsListImporterProps> = ({
  orderId,
  projectId,
  onImportComplete
}) => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // Import as order-specific parts list
      ...
      // Reset file input
      const fileInput = document.getElementById('order-csv-file-input') as HTMLInputElement;
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Import Parts List for Order
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="order-csv-file-input">CSV File</Label>
            <Input
              id="order-csv-file-input"
              type="file"
              accept=".csv"
