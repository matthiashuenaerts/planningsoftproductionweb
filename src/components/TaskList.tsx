                    ...
                    <div className="mt-2 space-y-1">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-600">
                          Planned: {task.total_duration ? formatDuration(task.total_duration) : 'N/A'}
                          {task.actual_duration_minutes && ` / Actual: ${formatDuration(task.actual_duration_minutes)}`}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                  ...
                  {task.total_duration && (
                    <div className="flex items-center gap-1">
                      ...
                      <span>Duration: {formatDuration(task.total_duration)}</span>
                    </div>
                  )}
                </div>
              )}
