const marketing: Record<string, Record<string, string>> = {
  nl: {
    ...
    hero_trusted: "Vertrouwd door productiebedrijven in België",

    // How it works
    how_badge: "Hoe het werkt",
    how_title: "In drie stappen operationeel",
    how_subtitle: "Van eerste gesprek tot volledige integratie in uw productieomgeving.",
    how_step1_title: "Inventarisatie & Configuratie",
    how_step1_desc: "We brengen uw werkstations, productieroutes en teams in kaart. Uw omgeving wordt volledig op maat ingericht.",
    how_step2_title: "Data-import & Integratie",
    how_step2_desc: "Bestaande bestellingen, projecten en personeelsdata worden geïmporteerd. CrownBase Pro koppeling wordt geactiveerd.",
    how_step3_title: "Training & Livegang",
    how_step3_desc: "Uw team krijgt hands-on training. Binnen enkele dagen draait uw productie volledig digitaal.",
    ...
    // Module grid
    modules_badge: "Volledige suite",
    modules_title: "Alles wat u nodig heeft",
    modules_subtitle: "9+ modules die naadloos samenwerken voor uw productieomgeving.",
    mod_projects: "Projectbeheer",
    mod_projects_desc: "Intake tot oplevering",
    mod_planning: "Gantt Planning",
    mod_planning_desc: "Drag-and-drop scheduling",
    mod_logistics: "Logistiek IN/UIT",
    mod_logistics_desc: "Barcode scanning & tracking",
    mod_rush: "Spoedbestellingen",
    mod_rush_desc: "Prioriteit & notificaties",
    mod_teams: "Installatieploegen",
    mod_teams_desc: "Planning & vrachtwagenbelading",
    mod_time: "Tijdsregistratie",
    mod_time_desc: "Urenregistratie & rapportage",
    mod_dashboards: "Dashboards",
    mod_dashboards_desc: "Realtime productieoverzicht",
    mod_broken: "Beschadigde onderdelen",
    mod_broken_desc: "Registratie & spoedopdrachten",
    mod_hr: "Verlofbeheer",
    mod_hr_desc: "Aanvragen & goedkeuring",

    // Testimonial / social proof
    proof_badge: "Resultaten",
    proof_title: "Meetbare impact op uw productie",
    proof_subtitle: "Ontdek hoe AutoMattiOn Compass productiebedrijven helpt efficiënter te werken.",
    proof_stat1: "Minder planningsfouten",
    proof_stat2: "Tijdsbesparing per week",
    proof_stat3: "Snellere doorlooptijd",
    proof_stat4: "Minder zoektijd onderdelen",
  ...
  en: {
    ...
    hero_trusted: "Trusted by production companies in Belgium",

    how_badge: "How it works",
    how_title: "Operational in three steps",
    how_subtitle: "From first conversation to full integration in your production environment.",
    how_step1_title: "Inventory & Configuration",
    how_step1_desc: "We map your workstations, production routes and teams. Your environment is fully customized.",
    how_step2_title: "Data Import & Integration",
    how_step2_desc: "Existing orders, projects and personnel data are imported. CrownBase Pro integration is activated.",
    how_step3_title: "Training & Go-Live",
    how_step3_desc: "Your team receives hands-on training. Within days, your production runs fully digital.",
    ...
    modules_badge: "Full suite",
    modules_title: "Everything you need",
    modules_subtitle: "9+ modules that work seamlessly together for your production environment.",
    mod_projects: "Project Management",
    mod_projects_desc: "Intake to delivery",
    mod_planning: "Gantt Planning",
    mod_planning_desc: "Drag-and-drop scheduling",
    mod_logistics: "Logistics IN/OUT",
    mod_logistics_desc: "Barcode scanning & tracking",
    mod_rush: "Rush Orders",
    mod_rush_desc: "Priority & notifications",
    mod_teams: "Installation Teams",
    mod_teams_desc: "Planning & truck loading",
    mod_time: "Time Registration",
    mod_time_desc: "Hour tracking & reports",
    mod_dashboards: "Dashboards",
    mod_dashboards_desc: "Real-time production overview",
    mod_broken: "Broken Parts",
    mod_broken_desc: "Registration & rush orders",
    mod_hr: "Leave Management",
    mod_hr_desc: "Requests & approvals",

    proof_badge: "Results",
    proof_title: "Measurable impact on your production",
    proof_subtitle: "Discover how AutoMattiOn Compass helps production companies work more efficiently.",
    proof_stat1: "Fewer planning errors",
    proof_stat2: "Time saved per week",
    proof_stat3: "Faster lead time",
    proof_stat4: "Less time searching for parts",
  ...
  fr: {
    ...
    hero_trusted: "Adopté par des entreprises de production en Belgique",

    how_badge: "Comment ça marche",
    how_title: "Opérationnel en trois étapes",
    how_subtitle: "Du premier entretien à l'intégration complète dans votre environnement de production.",
    how_step1_title: "Inventaire & Configuration",
    how_step1_desc: "Nous cartographions vos postes de travail, routes de production et équipes. Votre environnement est entièrement personnalisé.",
    how_step2_title: "Import de Données & Intégration",
    how_step2_desc: "Les commandes, projets et données du personnel existants sont importés. L'intégration CrownBase Pro est activée.",
    how_step3_title: "Formation & Mise en Production",
    how_step3_desc: "Votre équipe reçoit une formation pratique. En quelques jours, votre production fonctionne entièrement en numérique.",
    ...
    modules_badge: "Suite complète",
    modules_title: "Tout ce dont vous avez besoin",
    modules_subtitle: "9+ modules qui fonctionnent ensemble pour votre environnement de production.",
    mod_projects: "Gestion de Projets",
    mod_projects_desc: "Admission à livraison",
    mod_planning: "Planning Gantt",
    mod_planning_desc: "Planification glisser-déposer",
    mod_logistics: "Logistique IN/OUT",
    mod_logistics_desc: "Scan codes-barres & suivi",
    mod_rush: "Commandes Urgentes",
    mod_rush_desc: "Priorité & notifications",
    mod_teams: "Équipes d'Installation",
    mod_teams_desc: "Planning & chargement",
    mod_time: "Enregistrement du Temps",
    mod_time_desc: "Suivi horaire & rapports",
    mod_dashboards: "Tableaux de Bord",
    mod_dashboards_desc: "Vue production en temps réel",
    mod_broken: "Pièces Endommagées",
    mod_broken_desc: "Enregistrement & urgences",
    mod_hr: "Gestion des Congés",
    mod_hr_desc: "Demandes & approbation",

    proof_badge: "Résultats",
    proof_title: "Impact mesurable sur votre production",
    proof_subtitle: "Découvrez comment AutoMattiOn Compass aide les entreprises à travailler plus efficacement.",
    proof_stat1: "Moins d'erreurs de planification",
    proof_stat2: "Temps économisé par semaine",
    proof_stat3: "Délai de livraison plus rapide",
    proof_stat4: "Moins de temps à chercher des pièces",
